...
import { medWorkerAndPatientApi } from "../service/medWorkerAndPatient";
...
export const store = configureStore({
    reducer: {
        ...
        [medWorkerAndPatientApi.reducerPath]: medWorkerAndPatientApi.reducer,
        [cytologyApi.reducerPath]: cytologyApi.reducer
    },

    middleware: (getDefaultMiddleware) =>
        getDefaultMiddleware()
            .concat(medWorkerAndPatientApi.middleware)
