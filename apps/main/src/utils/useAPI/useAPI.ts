...
export default function useAPI<T = any>({
    ...
    const fetchAPI = useCallback(
        ...
        [session, url, isShowErrorResultsNotification, api, errorTemplate]
    )
    ...
    const callback = useCallback<ReturnedCallback>(
        ...
        [authRequired, mutateAsync, session, isShowSuccessResultsNotification, isShowErrorResultsNotification, api, successTemplate, errorTemplate]
    )
