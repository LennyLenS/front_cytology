...
import { Flex, Form, Input, Space, Descriptions, Badge, Select, Tag, Col, Row, Button, Tooltip  } from 'antd';
...
const items: DescriptionsProps['items'] = [
    { key: 1, label: 'ФИО', children: lastName + ' ' + firstName + ' ' + fatherName },
    { key: 2, label: 'Дата рождения', children: birthDate },
    { key: 3, label: 'Полис', children: policy },
    { key: 4, label: 'Статус', children: <Space><Badge status={status ? 'processing' : 'default'}/><Text>{status ? 'Активный' : 'Не активный'}</Text></Space> },
...
const specialistOptions: Specialist[] = [
    ...
    { id: 4, lastName: 'Иванов1', firstName: 'Сергей', fatherName: 'Иванович', medOrganisation: 'Больница №1' },
    { id: 5, lastName: 'Алексеевна1', firstName: 'Анна', fatherName: 'Сергеевна', medOrganisation: 'Клиника "Здоровье"' },
    { id: 6, lastName: 'Сидоров1', firstName: 'Петр', fatherName: 'Алексеевич', medOrganisation: 'Медицинский центр "Вита"' },
    { id: 7, lastName: 'Иванов2', firstName: 'Иван', fatherName: 'Иванович', medOrganisation: 'Больница №1' },
    { id: 8, lastName: 'Петрова2', firstName: 'Анна', fatherName: 'Сергеевна', medOrganisation: 'Клиника "Здоровье"' },
    { id: 9, lastName: 'Сидоров2', firstName: 'Петр', fatherName: 'Алексеевич', medOrganisation: 'Медицинский центр "Вита"' },
    { id: 10, lastName: 'Иванов3', firstName: 'Иван', fatherName: 'Иванович', medOrganisation: 'Больница №1' },
    { id: 11, lastName: 'Петрова3', firstName: 'Анна', fatherName: 'Сергеевна', medOrganisation: 'Клиника "Здоровье"' },
    { id: 12, lastName: 'Сидоров3', firstName: 'Петр', fatherName: 'Алексеевич', medOrganisation: 'Медицинский центр "Вита"' }
];
...
export default function SendCard() {
    ...
    const filteredOptions = specialistOptions.filter((o) => !selectedItems.find(item => item == o.id));
    ...
    const options = filteredOptions.map((specialist) => ({
        ...
        optionFilterFullName: specialist.lastName + ' ' + specialist.firstName + ' ' + specialist.fatherName,
    ...
    const tagRender = (props: any) => {
        ...
        return (
            <Tooltip title={formatTooltip(props.value)}>
                <Tag onClose={onClose} onMouseDown={onPreventMouseDown} style={{ height: '34px', lineHeight: '30px', fontSize: '16px' }} closable>
                    ...
                    <Row justify='space-evenly'>
                        <Col span={8} >
                            <Flex style={{width:'auto'}} vertical>
                                ...
                                <Descriptions labelStyle={{fontWeight:500, fontSize:18}} contentStyle={{fontSize:20}} items={items} column={1}  bordered />
                            </Flex>
                        </Col>
                        ...
                        <Col span={14}>
                            ...
                            >
                                <Item name='id_patient' style={{ display: 'none' }}>
                                    <Input />
                                </Item>
                                ...
                                <Item name='type' label='Тип узла'>
                                    <Select style={{boxShadow: 'none'}} size='large' allowClear>
                                ...
                                <Item name='id_specialist' label='Специалисты' required={true}>
                                    <Select
                                        size='large'
                                        mode='multiple'
                                        options={options}
