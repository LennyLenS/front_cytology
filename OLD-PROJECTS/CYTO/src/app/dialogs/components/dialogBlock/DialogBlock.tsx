            ...
            <Flex>
                <div className="card">
                    <div className="column">
                        ...
                        <div className="date">{themeDate.format("DD.MM.YYYY")}</div>
                        <Button style={{ marginLeft: 1, top: 3 }} onClick={redirectToChat}>
                            Перейти
                        </Button>
                    </div>
                    <div className="column">
                        ...
                        <div className="birthday_date">{birthdayDate.format("DD.MM.YYYY")}</div>
                    </div>
                            ...
                            <Flex gap={20}>
                                <div>
                                    {showedExperts.map((expert, index) => {
                                        return (
                                            <>
                                                <div className="expert_card">{expert}</div>
                                                <ConditionalRender condition={index % 2 !== 0}>
                                                    <br />
                                                </ConditionalRender>
                                            </>
                                        );
                                ...
                                <ConditionalRender condition={!isShowExpert && experts.length > 2}>
                                    <Flex
                                        align="center"
