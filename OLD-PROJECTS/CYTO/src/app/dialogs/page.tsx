...
export default function DialogsPage() {
    ...
    useEffect(()=>{
        ...
        mockDialogs.push({
            ...
            experts: ['Иванов И.И. НМИЦ Эндокрионологии', 'Иванов И.И. НМИЦ Эндокрионологии', 'Иванов И.И. НМИЦ Эндокрионологии', 'Иванов И.И. НМИЦ Эндокрионологии'],
    ...
    return (
        <Page className="page dialogs_page">
            ...
            <Flex justify='space-between' align='center'>
                <Input style={{marginRight: "30px"}} prefix={<SearchOutlined/>} placeholder='Поиск по диалогам'  />
                <Flex justify="center" align="center" className="filter_box">
                <FilterTwoTone style={{fontSize: "18px", cursor: "pointer"}}/>
                </Flex>
            </Flex>
                <Flex vertical gap={20}>
                    {
                ...
                <Flex>
                    <Pagination style={{justifyContent: "right"}} total={dataSource.length}
                                defaultPageSize={10}
                                defaultCurrent={1}
